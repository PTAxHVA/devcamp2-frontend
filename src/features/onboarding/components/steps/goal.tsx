      ...
      {goals.map((goal) => (
        ...
        >
          <div className="absolute top-4 right-4 flex items-center justify-center">
            <div
              className={`flex h-5 w-5 items-center justify-center rounded-full border-2 transition-colors duration-200 ${selectedGoal === goal.id ? 'border-brand-purple-600' : 'border-border-input'} `}
            >
              {selectedGoal === goal.id && (
